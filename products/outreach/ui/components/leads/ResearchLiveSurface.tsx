...
import type { InsightCategory, LeadResearch } from '@/products/outreach/domain/types';
import {
...
function finalTopicCopy(topic: ResearchTopic, research: LeadResearch): string {
...
function persistedSources(topic: ResearchTopic, research: LeadResearch): ResearchSourcePreview[] {
...
export function ResearchLiveSurface({ leadName, research, run }: ResearchLiveSurfaceProps) {
            ...
            <div className="min-w-0">
              <p className="font-medium text-foreground">
                {isError
                  ? 'Research stopped'
                  : isComplete
                    ? `${leadName}’s research brief`
                    : `Building ${leadName}’s research brief`}
              </p>
