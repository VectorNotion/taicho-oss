...
import { solidifyDatabasePermissions } from "./permissions";
...
export async function runMigrations({
  ...
  if (solidifyPermissions) await solidifyDatabasePermissions();
}
...
if (isDirectExecution) {
  runMigrations({
    ...
    solidifyPermissions: !process.argv.includes("--defer-permissions"),
  })
    .then(() => {
