...
const runtimeGrantContracts = [
  {
    ...
    schema: "public",
    relations: [
      ["public.jobs", ["SELECT", "INSERT", "UPDATE", "DELETE"]],
      ...
      ["public.outreach_prospect_evidence", ["SELECT", "INSERT", "UPDATE", "DELETE"]],
      ["public.outreach_prospect_insight_snapshots", ["SELECT", "INSERT", "UPDATE", "DELETE"]],
      ["public.outreach_prospect_meeting_events", ["SELECT", "INSERT", "UPDATE", "DELETE"]],
      ["public.outreach_prospect_meetings", ["SELECT", "INSERT", "UPDATE", "DELETE"]],
  ...
  },
  {
    ...
    relations: [
      ...
      ["public.outreach_prospect_source_identities", ["SELECT", "INSERT", "UPDATE"]],
    ],
  },
  {
