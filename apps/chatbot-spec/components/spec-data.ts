...
export const PHASES: PhaseSpec[] = [
  ...
  },
  {
    ...
    shortLabel: 'Intent',
    label: 'Orient',
    visibleCopy: 'Looking for a matching lead and your relationship history.',
    target: '≤ 400 ms',
  ...
  },
  {
    ...
    visibleCopy: 'Searching leads for “Aisha Rahman”…',
    target: 'start ≤ 500 ms',
  ...
  },
  {
    ...
    motion: 'The search row settles to a check; the lead card grows in place without layout jump.',
  },
  {
    id: 'delegate',
    shortLabel: 'Delegate',
  ...
  },
  {
    ...
    visibleCopy: 'Yes—you know Aisha. She is already a qualified lead with two prior touchpoints.',
...
export const DEMO_EVENT_SCRIPT: DemoRuntimeEvent[] = [
  ...
  { id: 'evt-04', event: 'tool.started', phase: 'search', source: 'rlm', delayMs: 850, summary: 'Select findLead and expose the tool start.', targets: ['WORK-03', 'WORK-04'] },
  { id: 'evt-05', event: 'tool.progress', phase: 'search', source: 'tool', delayMs: 650, summary: 'Stream a partial lead match.', targets: ['WORK-04', 'DATA-01'] },
  { id: 'evt-06', event: 'entity.discovered', phase: 'evidence', source: 'tool', delayMs: 900, summary: 'Resolve the lead and relationship summary.', targets: ['DATA-01', 'DATA-06'] },
...
export const TOOL_GROUPS: ToolGroup[] = [
  {
    ...
    tone: 'text-sky-300',
    tools: [
      { name: 'searchKnowledge', purpose: 'Search leads, projects, research, topics, drafts, and articles.', policy: 'automatic' },
      { name: 'findLead / getLead', purpose: 'Resolve a person by name and load the full relationship record.', policy: 'automatic' },
  ...
  },
  {
    ...
    tools: [
      ...
      { name: 'draftOutreach', purpose: 'Create channel-aware outreach grounded in the lead record.', policy: 'conditional' },
    ],
  },
  {
    id: 'actions',
    ...
    tone: 'text-amber-300',
    tools: [
      { name: 'createOrUpdateLead', purpose: 'Create a record or apply proposed field changes.', policy: 'confirmation' },
      ...
      { name: 'enrollInNurture', purpose: 'Add a lead to a named cadence with visible consequences.', policy: 'confirmation' },
    ],
  },
  {
    id: 'orchestration',
...
export const SURFACES: SurfaceSpec[] = [
  ...
  {
    id: 'DATA-01',
    title: 'Lead Result Card',
    purpose: 'Turns lead tool output into an immediately recognizable relationship record.',
  ...
  },
  {
    id: 'DATA-05',
    title: 'Topic Map',
    purpose: 'Shows the focal topic, connected themes, evidence density, and gaps.',
    driver: 'topic.graph.updated',
    settledDriver: 'topic.graph.completed',
    activeState: 'building',
    settledState: 'complete',
    enters: 'nodes appear by relevance',
    active: 'Connections settle as evidence is classified.',
    settles: 'Stable map with an expandable evidence panel.',
    icon: BrainCircuit,
  },
  {
    id: 'AGENT-05',
...
export const COMPONENT_CATALOG: ComponentSpec[] = [
  ...
  { id: 'DATA-01', name: 'Lead Result Card', category: 'Data', purpose: 'Shows identity, qualification, relationship history, and relevant lead actions.', states: ['skeleton', 'partial', 'complete', 'stale'] },
  ...
  { id: 'DATA-05', name: 'Topic Map', category: 'Data', purpose: 'Visualizes a focal topic, connected themes, evidence count, and knowledge gaps.', states: ['building', 'complete', 'filtered', 'empty'] },
...
export const PERFORMANCE_BUDGETS = [
  ...
  { metric: 'Local knowledge result', target: 'p50 < 1.2 s · p95 < 2.5 s', meaning: 'Lead, project, topic, or research data becomes usable.' },
...
export const EVENT_CONTRACT = [
  ...
  { event: 'entity.discovered', payload: 'entity type, summary, provenance', renderer: 'Lead/article/topic/project card' },
